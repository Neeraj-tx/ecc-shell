    ...
    <>
      <div className="flex-col justify-center items-center">
        <div className="h-48 p-2 w-192 flex justify-center items-end py-6">
          ...
          <p className="text-8xl text-tekhelet p-2">John</p>
        </div>
        <div className="flex justify-center items-center">
          <div className=" flex flex-col justify-start items-center w-64 h-48 rounded-md hover:shadow-md p-4 m-2 bg-tekhelet">
          ...
          <div className=" flex flex-col justify-start items-center w-70 h-48 rounded-md hover:shadow-md p-4 m-2 bg-tekhelet">
